...
"initialize",a=[].slice,h="undefined"==typeof _?$[i]:_[i],c=
function(){};t[i]=function(r,e){function o(t){this[s](t),this[u]
(t)}return o[i]=t[i],h(o[n],this[n],r),h(o,e),o};var f=t.
...
]=c,l[r]=f[r],h(l,{set:function(t){var n=this[e];for(var i in t)
{var o=t[i],s=n[i];o!==s&&(n[i]=o,this[r]("change:"+i,this,o),
this[r]("change",this))}return this},get:function(t){return this
[e][t]},on:f.on});var p=t.View=function(){};p[i]=t[i];var g=p[n]
;return g[s]=function(t){t=t||{},this.$el=$(t.el||document)},g[u
]=c,g[r]=f[r],h(g,{$:function(t){return this.$el.find(t)},on:f.
on}),t}();
