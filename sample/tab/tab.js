...
return this[e]={},this.set(t)},h(l,{set:function(t){var n=this[e
];for(var i in t){var o=t[i],s=n[i];o!==s&&(n[i]=o,this[r](
"change:"+i,this,o),this[r]("change",this))}return this},get:
function(t){return this[e][t]}});var g=t.View=function(){};g[i]=
t[i];var p=g[n];return p[s]=function(t){t=t||{},this.$el=$(t.el)
},h(p,{$:function(t){return this.$el.find(t)}}),l[u]=p[u]=c,l[r]
=p[r]=f[r],l.on=p.on=f.on,t}();
